...
@section('container')
    ...
    <section class="container ">
        <h3 class="text-3xl font-bold m-6">Locations</h3>
    </section>
    ...
    <section class="container mx-6 my-4">
        <a href="/dashboard/places/create" class="px-4 py-2 bg-sky-500 rounded-full text-white">New Location</a>
    </section>
                                ...
                                @foreach ($locations as $location)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="/dashboard/places/{{ $location->id }}"
